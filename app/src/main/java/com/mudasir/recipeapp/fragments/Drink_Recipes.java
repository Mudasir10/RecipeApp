...
public class Drink_Recipes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_drink__recipes, container, false);
    ...
    private void init(View root) {
        ...
        mRecyclerView=root.findViewById(R.id.rv_drink_recipes);
    ...
    private void RetriveFromFirebaseDatabase() {
        ...
        Query query=  mDatabaseRef.orderByChild("category").equalTo("Drink Recipes");
