...
public class Cake_Recipes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_cake__recipes, container, false);
    ...
    private void init(View root) {
        ...
        mRecyclerView=root.findViewById(R.id.rv_cake_recipes);
    ...
    private void RetriveFromFirebaseDatabase() {
        ...
        Query query=  mDatabaseRef.orderByChild("category").equalTo("Cake Recipes");
