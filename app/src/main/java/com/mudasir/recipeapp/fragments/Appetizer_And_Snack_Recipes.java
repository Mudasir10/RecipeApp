...
public class Appetizer_And_Snack_Recipes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_appetizer__and__snack__recipes, container, false);
    ...
    private void init(View root) {
        ...
        mRecyclerView=root.findViewById(R.id.rv_appetizer_and_snack_recipes);
    ...
    private void RetriveFromFirebaseDatabase() {
        ...
        Query query=  mDatabaseRef.orderByChild("category").equalTo("Appetizer And Snack Recipes");
