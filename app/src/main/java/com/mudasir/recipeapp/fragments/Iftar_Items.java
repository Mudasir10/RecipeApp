...
public class Iftar_Items extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_iftar__items, container, false);
    ...
    private void init(View root) {
        ...
        mRecyclerView=root.findViewById(R.id.rv_iftar_recipes);
    ...
    private void RetriveFromFirebaseDatabase() {
        ...
        Query query=  mDatabaseRef.orderByChild("category").equalTo("Iftar Items");
